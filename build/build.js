...
require.register("serandomps~autos-details@master", function (exports, module) {
var dust = require('serandomps~dust@master')();
var serand = require('serandomps~serand@master');
...
dust.loadSource(dust.compile(require('serandomps~autos-details@master/template.html'), 'autos-details'));
...
module.exports = function (sandbox, fn, options) {
    $.ajax({
        ...
        dataType: 'json',
        success: function (data) {
            dust.render('autos-details', utils.cdn800x450(data), function (err, out) {
                sandbox.append(out);
                if (!fn) {
                    return;
                }
...
require.define("serandomps~autos-details@master/template.html", "<div class=\"autos-details row\">\n    <div class=\"col-md-6\">\n        <div class=\"blueimp-gallery blueimp-gallery-carousel\">\n            <div class=\"slides\"></div>\n            <h3 class=\"title\"></h3>\n            <a class=\"prev\">‹</a>\n            <a class=\"next\">›</a>\n            <a class=\"play-pause\"></a>\n            <ol class=\"indicator\"></ol>\n        </div>\n    </div>\n    <div class=\"col-md-6\">\n        <table class=\"table table-striped table-bordered\">\n            <tbody>\n            <tr>\n                <td>Make</td>\n                <td>{make}</td>\n            </tr>\n            <tr>\n                <td>Model</td>\n                <td>{model}</td>\n            </tr>\n            <tr>\n                <td>Year</td>\n                <td>{year}</td>\n            </tr>\n            <tr>\n                <td>Color</td>\n                <td>{color}</td>\n            </tr>\n            <tr>\n                <td>Condition</td>\n                <td>{condition}</td>\n            </tr>\n            <tr>\n                <td>Mileage</td>\n                <td>{mileage}</td>\n            </tr>\n            <tr>\n                <td>Transmission</td>\n                <td>{transmission}</td>\n            </tr>\n            <tr>\n                <td>Price</td>\n                <td>{price}</td>\n            </tr>\n            <tr>\n                <td>Description</td>\n                <td>{description}</td>\n            </tr>\n            </tbody>\n        </table>\n    </div>\n</div>");

require.register("serandomps~autos-search@master", function (exports, module) {
var dust = require('serandomps~dust@master')();
var serand = require('serandomps~serand@master');

dust.loadSource(dust.compile(require('serandomps~autos-search@master/template.html'), 'autos-search'));
...
module.exports = function (sandbox, fn, options) {
    options = options || {};
    dust.render('autos-search', {}, function (err, out) {
        if (err) {
            return;
        }
...
dust.loadSource(dust.compile(require('serandomps~autos-add@master/preview.html'), 'autos-add-preview'));
dust.loadSource(dust.compile(require('serandomps~autos-add@master/template.html'), 'autos-add'));

var render = function (sandbox, fn, data) {
    var update = data._.update;
    var id = data.id;
    var existing = data.photos || [];
    dust.render('autos-add', utils.cdn288x162(data), function (err, out) {
        if (err) {
            return;
        }
        var elem = sandbox.append(out);
...
var list = function (el, options, fn) {
    $.ajax({
        ...
        dataType: 'json',
        success: function (data) {
            dust.render('autos-listing', utils.cdn288x162(data), function (err, out) {
                $('.autos-listing', el).remove();
...
dust.loadSource(dust.compile(require('serandomps~autos-listing@master/template.html'), 'autos-listing'));
